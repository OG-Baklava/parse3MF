  ...
  if (index) {
    ...
    for (let i = 0; i < index.count; i += 3) {
      volume += signedVolumeOfTriangle(
        new THREE.Vector3(position.getX(arr[i]), position.getY(arr[i]), position.getZ(arr[i])),
        new THREE.Vector3(position.getX(arr[i + 1]), position.getY(arr[i + 1]), position.getZ(arr[i + 1])),
        new THREE.Vector3(position.getX(arr[i + 2]), position.getY(arr[i + 2]), position.getZ(arr[i + 2]))
      );
    }
  } else {
...
async function parse3MF(file) {
  try {
    ...
    for (let i = 0; i < allGeomObjects.length; i++) {
      ...
      geometry.setAttribute("position", new THREE.BufferAttribute(new Float32Array(obj.vertices), 3));
...
function ThreeMFProvider({
  ...
  const callbackRefs = react.useRef({ onParsed, onError, onSlotColorChange, onPlateChange, onExported });
  ...
  const setSlotColor = react.useCallback((slotId, color) => {
    dispatch({ type: "SET_SLOT_COLOR", slotId, color });
  }, []);
  react.useEffect(() => {
    if (state.materialSlots.length > 0) ;
  }, [state.materialSlots]);
  const selectPlate = react.useCallback((plateId) => {
  ...
  const exportFile = react.useCallback(async (colorOptions) => {
  ...
  const downloadFile = react.useCallback(async (filename, colorOptions) => {
    const s = stateRef.current;
  ...
  const hasColorChanges = state.model ? state.materialSlots.some((slot) => {
...
function buildMultiMaterialGeometry(src, triColorMap, slots) {
  ...
  const materials = slotOrder.map(
    (si) => new THREE__namespace.MeshPhongMaterial({ color: colorToHex(slots[si].selectedColor), specular: 1118481, shininess: 200 })
  );
  return { geometry: geom, materials, slotOrder };
}
function centerAndScale(meshes, scene) {
  if (meshes.length === 0) return;
  const tmp = new THREE__namespace.Group();
  meshes.forEach((m) => tmp.add(m));
  const box = new THREE__namespace.Box3().setFromObject(tmp);
...
function makeMaterial(hex) {
  return new THREE__namespace.MeshPhongMaterial({ color: hex, specular: 1118481, shininess: 200 });
}
function Viewer({ theme: themeOverrides, className, style, showDebugOverlay }) {
  ...
  const slotOrderRef = react.useRef(/* @__PURE__ */ new Map());
  const ownedGeomsRef = react.useRef(/* @__PURE__ */ new Set());
  ...
  const slotsRef = react.useRef(materialSlots);
  slotsRef.current = materialSlots;
  const { filteredGeometries, originalIndices } = react.useMemo(() => {
  ...
  react.useEffect(() => {
    ...
    scene.background = new THREE__namespace.Color(theme.background);
    const w = el.clientWidth || 300;
    const h = el.clientHeight || 300;
    const camera = new THREE__namespace.PerspectiveCamera(50, w / h, 0.1, 2e3);
    ...
    scene.add(new THREE__namespace.AmbientLight(16777215, 0.5));
    const d1 = new THREE__namespace.DirectionalLight(16777215, 0.8);
    d1.position.set(1, 1, 1);
    scene.add(d1);
    const d2 = new THREE__namespace.DirectionalLight(16777215, 0.5);
        ...
        for (let fi = 0; fi < filteredGeometries.length; fi++) {
          ...
          if (isMultiColor && slots.length > 1) {
            ...
            if (triMap && triMap.size > 0) {
              ...
              if (uniq.size > 1) {
                ...
                if (result) {
                  ...
                  const mesh2 = new THREE__namespace.Mesh(result.geometry, result.materials);
              ...
              const mesh = new THREE__namespace.Mesh(geom, makeMaterial(colorToHex(slot?.selectedColor ?? hex)));
            ...
            if (geomSlots.length > 0) {
              ...
              const mesh = new THREE__namespace.Mesh(geom, makeMaterial(colorToHex(slot.selectedColor)));
              newSlotOrder.set(newMeshes.length, [si]);
              newMeshes.push(mesh);
              continue;
            }
          }
          newMeshes.push(new THREE__namespace.Mesh(geom, makeMaterial(colorToHex(clr))));
        }
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { ref: containerRef, className, style: containerStyle, children: [
    showLoading && /* @__PURE__ */ jsxRuntime.jsx("div", { style: overlayStyle, children: /* @__PURE__ */ jsxRuntime.jsx(
      "div",
      {
        style: {
          width: "100%",
    ...
    error && /* @__PURE__ */ jsxRuntime.jsx("div", { style: overlayStyle, children: /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { textAlign: "center", padding: 32 }, children: [
      /* @__PURE__ */ jsxRuntime.jsx("p", { style: { color: "#ef4444", marginBottom: 8 }, children: "Failed to render model" }),
      /* @__PURE__ */ jsxRuntime.jsx("p", { style: { fontSize: 12, color: theme.textMuted }, children: error.message })
    ] }) }),
    showDebugOverlay && isMultiColor && materialSlots.length > 1 && /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
        style: {
          position: "absolute",
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx("div", { style: { display: "flex", gap: 3, marginTop: 4, flexWrap: "wrap" }, children: materialSlots.map((s, i) => /* @__PURE__ */ jsxRuntime.jsx(
            "div",
            {
              style: {
                width: 12,
          ...
          debugInfo && /* @__PURE__ */ jsxRuntime.jsx("div", { style: { marginTop: 4, fontSize: 9, color: "rgba(74,222,128,0.6)", whiteSpace: "pre-wrap" }, children: debugInfo })
        ]
      }
    )
  ] });
...
function ColorPicker({ colorOptions, theme: themeOverrides, className, style }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className, style: rootStyle, children: [
    /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8, marginBottom: 12 }, children: [
      /* @__PURE__ */ jsxRuntime.jsx("svg", { width: 16, height: 16, viewBox: "0 0 24 24", fill: "none", stroke: theme.accent, strokeWidth: 2, children: /* @__PURE__ */ jsxRuntime.jsx(
        "path",
        {
          strokeLinecap: "round",
      ...
      /* @__PURE__ */ jsxRuntime.jsx("span", { style: { fontSize: 12, fontWeight: 500, color: theme.textMuted }, children: "Multi-color" })
    ] }),
    /* @__PURE__ */ jsxRuntime.jsxs("p", { style: { fontSize: 11, color: theme.textMuted, marginBottom: 12 }, children: [
      materialSlots.length,
      " filament",
      materialSlots.length !== 1 ? "s" : "",
      " \u2014 select colors:"
    ] }),
    /* @__PURE__ */ jsxRuntime.jsx("div", { style: { display: "flex", flexDirection: "column", gap: 8 }, children: materialSlots.map((slot, index) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs(
        "div",
        {
          ...
          children: [
            originalColorHex && /* @__PURE__ */ jsxRuntime.jsx(
              "div",
              {
                style: {
                  width: 16,
            ...
            /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { flex: 1, display: "flex", alignItems: "center", gap: 8, minWidth: 0 }, children: [
              /* @__PURE__ */ jsxRuntime.jsx(
                "div",
                {
                  style: {
              ...
              /* @__PURE__ */ jsxRuntime.jsxs(
                "select",
                {
                  ...
                  children: [
                    isHexColor && /* @__PURE__ */ jsxRuntime.jsxs("option", { value: slot.selectedColor, children: [
                      "Original (",
                      slot.selectedColor,
                      ")"
                    ] }),
                    colors.map((c) => /* @__PURE__ */ jsxRuntime.jsx("option", { value: c.name, children: c.name }, c.name))
                  ]
                }
              )
            ] })
...
function PlateSelector({ theme: themeOverrides, className, style }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className, style: { fontFamily: theme.fontFamily, ...style }, children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      "label",
      {
        style: {
    ...
    /* @__PURE__ */ jsxRuntime.jsx(
      "select",
      {
        ...
        children: plates.map((plate) => /* @__PURE__ */ jsxRuntime.jsxs("option", { value: plate.id, children: [
          plate.name,
          " (",
    ...
    selectedPlateId && /* @__PURE__ */ jsxRuntime.jsxs("p", { style: { fontSize: 11, color: theme.textMuted, marginTop: 8 }, children: [
...
function SaveButton({
  ...
  const buttonStyle = {
    ...
    gap: 8,
    transition: "all 0.2s",
    background: saved ? "#22c55e" : hasColorChanges ? theme.accent : `${theme.surface}`,
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className, children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      "button",
      {
        ...
        children: exporting ? /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
          /* @__PURE__ */ jsxRuntime.jsx(Spinner, { color: hasColorChanges ? "#ffffff" : theme.textMuted }),
          "Exporting\u2026"
        ] }) : saved ? /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
          /* @__PURE__ */ jsxRuntime.jsx("svg", { width: 16, height: 16, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 2.5, children: /* @__PURE__ */ jsxRuntime.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M5 13l4 4L19 7" }) }),
          "Saved!"
        ] }) : /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
          /* @__PURE__ */ jsxRuntime.jsx("svg", { width: 16, height: 16, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 2, children: /* @__PURE__ */ jsxRuntime.jsx(
            "path",
            {
              strokeLinecap: "round",
              strokeLinejoin: "round",
    ...
    hasColorChanges && !saved && !exporting && /* @__PURE__ */ jsxRuntime.jsx(
      "p",
      {
        style: {
          fontSize: 10,
        ...
        children: "Colors changed \u2014 save to apply"
      }
    )
  ] });
}
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "svg",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx("circle", { cx: 12, cy: 12, r: 10, stroke: color, strokeWidth: 3, opacity: 0.25 }),
        /* @__PURE__ */ jsxRuntime.jsx(
          "path",
          {
...
function WorkbenchInner({
  ...
  const theme = resolveTheme(themeOverrides);
  const prevFileRef = react.useRef(null);
  react.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className, style: rootStyle, children: [
    /* @__PURE__ */ jsxRuntime.jsx("div", { style: { flex: 1, minHeight: 300 }, children: /* @__PURE__ */ jsxRuntime.jsx(Viewer, { theme: themeOverrides, showDebugOverlay: true }) }),
    model && /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
        style: {
          width: 260,
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(PlateSelector, { theme: themeOverrides }),
          /* @__PURE__ */ jsxRuntime.jsx(ColorPicker, { theme: themeOverrides, colorOptions }),
          showSaveButton && /* @__PURE__ */ jsxRuntime.jsx(SaveButton, { theme: themeOverrides, colorOptions })
        ]
      }
    )
  ] });
...
function ThreeMFWorkbench(props) {
  return /* @__PURE__ */ jsxRuntime.jsx(
    ThreeMFProvider,
    {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsx(WorkbenchInner, { ...props })
    }
  );
}
...
exports.PlateSelector = PlateSelector;
exports.SaveButton = SaveButton;
exports.ThreeMFParseError = ThreeMFParseError;
exports.ThreeMFProvider = ThreeMFProvider;
exports.ThreeMFWorkbench = ThreeMFWorkbench;
...
exports.download3MF = download3MF;
exports.export3MF = export3MF;
exports.parse3MF = parse3MF;
exports.resolveTheme = resolveTheme;
exports.useThreeMF = useThreeMF;
